...
import deliveryIcon from '../../resources/icons/delivery__icon.svg';
import pickupIcon from '../../resources/icons/pickup__icon.svg'
            ...
            <section className='delivery-banner'>
                <div className='container'>
                    <div className='delivery-banner__row'>
                        ...
                        <form className='delivery-banner__form'>
                            <div className='delivery-banner__form_top'>
                                <input type='radio' id='input__delivery' name='input__delivery'/>
                                ...
                                <input type='radio' id='input__pickup' name='input__delivery'/>
