                ...
                <ul className="about-service__row">
                    <motion.li className="about-service__row_item row__item">
                        ...
                        <div className="row__item_text">
                            ...
                            <p>
                                Choose the location where your food will be
                                delivered.
                            </p>
                        </div>
                    </motion.li>
                    <li className="about-service__row_item row__item">
                        ...
                        <div className="row__item_text">
                            <h3>Choose order</h3>
                            <p>
                                Check over hundreds of menus to pick your
                                favorite food
                            </p>
                        </div>
                    </li>
                    <li className="about-service__row_item row__item">
                        ...
                        <div className="row__item_text">
                            <h3>Pay advanced</h3>
                            <p>
                                It`&apos;`s quick, safe, and simple. Select
                    ...
                    <li className="about-service__row_item row__item">
                        ...
                        <div className="row__item_text">
                            <h3>Enjoy meals</h3>
                            <p>
                                Food is made and delivered directly to your
                                home.
                            </p>
                        </div>
                    </li>
