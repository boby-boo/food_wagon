                            ...
                            <div className="footer__social">
                                ...
                                <ul className="footer__social_row">
                                    <li>
                                        ...
                                        >
                                            <svg
                                                className="footer__social_row_icon"
                                                width="22"
                                                height="22"
                                                viewBox="0 0 22 22"
                                                fill="none"
