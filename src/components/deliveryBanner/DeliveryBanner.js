                ...
                <div className="delivery-banner__row">
                    ...
                    >
                        <div className="delivery-banner__form_top">
                            ...
                            >
                                <svg
                                    className="input__delivery_icon"
                                    width="24"
                                    height="15"
                                    viewBox="0 0 24 15"
                                    fill="none"
